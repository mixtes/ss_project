...
assemble_tests:
	for file in ./tests/nivo-b/*.s; do \
		./$(ASSEMBLER_EXEC) -o $${file%.s}.o $$file; \
	done

# Run linker on all .o files in ./tests/nivo-a/
link_tests:
	./$(LINKER_EXEC) --hex --place=my_code@0x40000000 -o program.hex ./tests/nivo-b/*.o

# Run emulator with the hex file generated by the linker
emulate_tests:
	./$(EMULATOR_EXEC) program.hex

# Run all tests (assemble, link, and emulate)
run_all_tests: assemble_tests link_tests emulate_tests
